...
let RabbitmqService = class RabbitmqService {
    ...
    async startConsumer() {
        try {
            ...
            await this.channel.consume(rabbitmq_config_1.RabbitmqConfig.queues.orderProcess, async (message) => {
                if (message) {
                    try {
                        const orderEvent = JSON.parse(message.content.toString());
                        console.log("Kitchen Service received order:", orderEvent.orderId);
...
exports.RabbitmqService = RabbitmqService = __decorate([
    ...
    __param(0, (0, common_1.Inject)((0, common_1.forwardRef)(() => kitchen_service_1.KitchenService))),
